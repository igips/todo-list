...
function editTask(id) {
    ...
    if(taskFromList.dateObj != "") {
        inputDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(taskFromList.dateObj, "yyyy-MM-dd");
    }
    ...
    imgAccept.addEventListener("click",() => {
        ...
        if(inputDate.valueAsDate != null) {
            ...
            taskFromList.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(inputDate.valueAsDate,"dd/MM/yyyy");
        } else {
...
function completeEditingTask(id, name, date, ele) {
    ...
    (0,_eventlis__WEBPACK_IMPORTED_MODULE_0__.addEventListenerToEditTaskButton)(document.querySelector("[data-id='"+id+"']"), id);
    (0,_eventlis__WEBPACK_IMPORTED_MODULE_0__.addEventListenerToEditTaskButton)(document.getElementById(id), id);
    (0,_eventlis__WEBPACK_IMPORTED_MODULE_0__.addEventListenerToRemoveTaskButton)(document.querySelector("[data-id='"+id+"D']"), id);
    document.getElementById("add-task").style.visibility = "visible";
    (0,_eventlis__WEBPACK_IMPORTED_MODULE_0__.checkBoxEvent)(document.querySelector("[data-id='"+id+"Ch']"), document.querySelector("[data-id='"+id+"Left']"), document.querySelector("[data-id='"+id+"Right']"), id);
...
function createTaskVisual(title, date, id) {
    ...
    (0,_eventlis__WEBPACK_IMPORTED_MODULE_0__.addEventListenerToEditTaskButton)(divTask, id);
    ...
    (0,_eventlis__WEBPACK_IMPORTED_MODULE_0__.checkBoxEvent)(checkBox, divLeft, divRight, id);
    if(a.checked == true) {
...
function getDataFromTaskFormAndCreateTask() {
    ...
    if(document.getElementById("datePicker").valueAsDate != null) {
        date = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(document.getElementById("datePicker").valueAsDate,"dd/MM/yyyy");
...
function checkBoxEvent(ele, div, div2, id) {
    let a = (0,_domMani__WEBPACK_IMPORTED_MODULE_0__.returnTaskById)(id);
